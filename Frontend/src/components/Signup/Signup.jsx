        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            {[
              ...
              { label: "Password", name: "password", type: formData.visible ? "text" : "password", autoComplete: "current-password" },
            ].map((input, index) => (
              <div key={index}>
                ...
                <div className="mt-1 relative">
                  ...
                  {input.name === "password" && (
                    <span
                      ...
                      onClick={() => setFormData((prevData) => ({ ...prevData, visible: !prevData.visible }))}
                    >
                      {formData.visible ? <AiOutlineEye size={25} /> : <AiOutlineEyeInvisible size={25} />}
                    </span>
                  )}
                </div>
              </div>
            ...
            <div className={`${styles.commonFlex} w-full`}>
