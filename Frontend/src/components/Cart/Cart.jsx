...
const Cart = ({ setOpenCart }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#000000] h-screen z-10">
  ...
  return (
    <div className="border-b p-4">
      <div className="w-full flex items-center">
        <div>
          <div className={`bg-[#e44343] border border-[#e4434373] rounded-full w-[25px] h-[25px] ${styles.commonFlex} justify-center cursor-pointer`} onClick={() => updateQuantity(true)}>
            <HiPlus size={18} color="#fff" />
          </div>
          <span className="pl-[10px]">{value}</span>
          <div className="bg-[#a7abb14f] rounded-full w-[25px] h-[25px] flex items-center justify-center cursor-pointer" onClick={() => updateQuantity(false)}>
